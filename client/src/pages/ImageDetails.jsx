  ...
  return (
    <div className="bg-black min-h-screen relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-24 pb-20 relative z-20"
      >
      ...
      {relatedImages.length > 0 && (
        <motion.div 
          ...
          viewport={{ once: true }}
          className="border-t border-zinc-800/50 py-20 px-6 md:px-12 lg:px-24 bg-zinc-950/50"
        >
